...
export class SoundcloudComponent implements AfterViewInit {
  ...
  constructor(public sanitizer: DomSanitizer, public spotifyPlaybackService: SpotifyPlaybackService, public apiService: ApiService) {
  ...
  @ViewChild('id', {static: false}) iframe: ElementRef;
  ...
  initializeWidget() {
    ...
    var self = this;
    this.widget.bind(SC.Widget.Events.FINISH, this.end.bind(self));
    this.widget.bind(SC.Widget.Events.READY, this.playSong);
    this.widget.play();

    console.log(this.widget)
  }

  updateWidget(track_id: string) {

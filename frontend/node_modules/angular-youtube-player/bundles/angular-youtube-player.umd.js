(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('angular-youtube-player', ['exports', '@angular/core', 'rxjs'], factory) :
    (global = global || self, factory(global['angular-youtube-player'] = {}, global.ng.core, global.rxjs));
    ...
    var YTPlayerService = /** @class */ (function () {
        function YTPlayerService(config) {
            var _this = this;
            this.config = config;
            this.apiReady = new rxjs.BehaviorSubject(window['YT'] !== undefined);
        ...
        /** @nocollapse */ YTPlayerService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function YTPlayerService_Factory() { return new YTPlayerService(core.ɵɵinject(YTPlayerConfig)); }, token: YTPlayerService, providedIn: "root" });
    ...
    var YTPlayerComponent = /** @class */ (function () {
        function YTPlayerComponent(ytPlayerService) {
            ...
            this.unstarted = new core.EventEmitter();
            this.ended = new core.EventEmitter();
            this.playing = new core.EventEmitter();
            this.paused = new core.EventEmitter();
            this.buffering = new core.EventEmitter();
            this.cued = new core.EventEmitter();
        }
        ...
        YTPlayerComponent.propDecorators = {
            ...
            unstarted: [{ type: core.Output }],
            ended: [{ type: core.Output }],
            playing: [{ type: core.Output }],
            paused: [{ type: core.Output }],
            buffering: [{ type: core.Output }],
            cued: [{ type: core.Output }]
        };
    ...
    exports.YTPlayerComponent = YTPlayerComponent;
    exports.YTPlayerConfig = YTPlayerConfig;
    exports.YTPlayerModule = YTPlayerModule;
    exports.YTPlayerService = YTPlayerService;
    exports.loadAPI = loadAPI;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=angular-youtube-player.umd.js.map

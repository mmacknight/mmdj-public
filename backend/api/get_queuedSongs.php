...
$songs = [];
$sql = "SELECT song_id, title, artist, genre, duration_ms, order_num, queuedSongs.popularity, playability FROM songs, queuedSongs where queuedSongs.event_id = {$event_id} and songs.song_id = queuedSongs.queuedSongs_id ORDER BY queuedSongs.order_num";
